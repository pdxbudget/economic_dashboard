...
if (
  ...
  data$port$passenger_historical <- read_xlsx(
    "inputs/data_port_air_historical.xlsx", sheet = "Passenger")
  ...
  saveRDS(data$port$passenger_historical, "inputs/data_port_air_historical.rds")
